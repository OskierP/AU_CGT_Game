...
running = True
background = pygame.image.load('assets/all2.png').convert()
burn = pygame.transform.scale(pygame.image.load("assets/esc.png"), (800,800))
tuto = pygame.transform.scale(pygame.image.load("assets/tuto.png"), (800,800))
burn_showed = False
