...
from LEVEL_1.camera import *
import LEVEL_1.game as game_module
...
def level1():
    ...
    running = True
    background = pygame.image.load('LEVEL_1/assets/all2.png').convert()
    burn = pygame.transform.scale(pygame.image.load("LEVEL_1/assets/esc.png"), (800,800))
    tuto = pygame.transform.scale(pygame.image.load("LEVEL_1/assets/tuto.png"), (800,800))
    burn_showed = False
