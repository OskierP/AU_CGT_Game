...
# load images
rocket_img1 = pygame.image.load('data/LEVEL_2/Assets/Rocket/Rocket1.png')
rocket_img2 = pygame.image.load('data/LEVEL_2/Assets/Rocket/Rocket2.png')
rocket_img3 = pygame.image.load('data/LEVEL_2/Assets/Rocket/Rocket3.png')
rocket_img4 = pygame.image.load('data/LEVEL_2/Assets/Rocket/Rocket4.png')
asteroid_img = pygame.image.load('data/LEVEL_2/Assets/Alien/asteroid1.png')
milkyway_img1 = pygame.image.load('data/LEVEL_2/Assets/Alien/milkyway1.png')
milkyway_img2 = pygame.image.load('data/LEVEL_2/Assets/Alien/milkyway2.png')
spaceship_img1 = pygame.image.load('data/LEVEL_2/Assets/Spaceship/Spaceship1.png')
spaceship_img2 = pygame.image.load('data/LEVEL_2/Assets/Spaceship/Spaceship2.png')
firestar = pygame.image.load('data/LEVEL_2/Assets/Alien/firestar.png')
firestar2 = pygame.image.load('data/LEVEL_2/Assets/Alien/firestar.png')
planet_img = pygame.image.load('data/LEVEL_2/Assets/Other/Planet.png')

# background image
bg_img = pygame.image.load('data/LEVEL_2/Assets/Other/spacebg.png').convert_alpha()
bg_img = pygame.transform.scale(bg_img, (SCREEN_WIDTH, SCREEN_HEIGHT))

# load music and sounds
# source https://www.youtube.com/watch?v=9NcPvmk4vfo
pygame.mixer.music.load('data/LEVEL_2/Assets/Other/space_ride_music.mp3')
...
def main():
    ...
    while run:
        ...
        if points > 2500:
            pygame.mixer.music.stop()
            data.progress.save_progress.update_progress('Level_3_1', True) #### TO DO: Around 2000 points Mars could move to sight and then level would end. Cutscene and new level
            run = False
