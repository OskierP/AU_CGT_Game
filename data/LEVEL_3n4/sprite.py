...
import data.LEVEL_3n4.movable_objects as movable_objects
...
class Platform(Sprite):
    def __init__(self, x, y, width, height=20):
        Sprite.__init__(self, 'data/LEVEL_3n4/assets/sprites/unmovable_obj/platform.png', x, y)
        self.x = x
        self.y = y
        self.width = width
        self.height = height
...
class Door(Sprite):
    def __init__(self, x, y, width=30, height=180):
        Sprite.__init__(self, 'data/LEVEL_3n4/assets/sprites/unmovable_obj/doors_4_1.png', x, y)
        self.x = x
        self.y = y
        self.width = width
        self.height = height
...
class Laser(Obstacles):
    def __init__(self, width, height, x, y):
        Obstacles.__init__(self, width, height, x, y)
        # # pygame.mixer.init()
        # pygame.mixer.music.load('data/LEVEL_3n4/assets/sound/laser_sound.mp3')
        # pygame.mixer.Sound.set_volume(1)
        self.sound_fx = pygame.mixer.Sound('data/LEVEL_3n4/assets/sound/laser_sound_effect.wav')
