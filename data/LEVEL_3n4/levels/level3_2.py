...
import data.LEVEL_3n4.display_game as display_game
import data.LEVEL_3n4.sprite as sprite
from data import flags as flags
import data.progress.save_progress
from data.LEVEL_3n4.movable_objects import Player, Box
...
def run_level(run):
    ...
    pygame.mixer.music.load('data/LEVEL_3n4/assets/sound/deep_space_music.mp3')
    pygame.mixer.music.play(-1)
    pygame.mixer.music.set_volume(0.2)
    button_click = pygame.mixer.Sound('data/LEVEL_3n4/assets/sound/button_click_effect.wav')
    jump_sound = pygame.mixer.Sound('data/LEVEL_3n4/assets/sound/audio_jump.wav')
    ...
    text = font.render('Press SPACEBAR to press the button', True, (0, 0, 0))
    ...
    level_4_2_background = sprite.Sprite('data/LEVEL_3n4/assets/sprites/background/level4_2.png').load_image()

    dog = Player('data/LEVEL_3n4/assets/sprites/player/dog_anim_left.png', 5, gravity, friction)
    scale = 2.25

    box = Box('data/LEVEL_3n4/assets/sprites/movable_obj/box.png', gravity, friction)
    box2 = Box('data/LEVEL_3n4/assets/sprites/movable_obj/box.png', gravity, friction)
    ...
    press_gravity = sprite.ActionPlace('data/LEVEL_3n4/assets/sprites/action_place/button.png', 1010, 100, 40, 40)
    keyboard = sprite.ActionPlace('data/LEVEL_3n4/assets/sprites/action_place/keyboard.png', 50, 150, 40, 40)
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                #         obj.friction = friction
                ...
                elif event.key == pygame.K_SPACE and press_gravity.flag and not was_pressed:
                    button_click.play()
                    ...
                    for obj in move_arr:
                        obj.gravity = gravity
                        obj.friction = friction
                elif event.key == pygame.K_SPACE and keyboard.flag:
                    button_click.play()
                    button_click.set_volume(0.5)
                    time.sleep(1)
                    running = False
                    data.progress.save_progress.update_progress('Level_4', True)
                    flags.next_lvl_3_2.set_flag(True)
