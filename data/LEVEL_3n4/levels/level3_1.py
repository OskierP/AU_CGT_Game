...
def run_level(run):
    ...
    level_4_1_background = sprite.Sprite('data/LEVEL_3n4/assets/sprites/background/level4_1.png').load_image()
    ...
    insert_box = sprite.ActionPlace('data/LEVEL_3n4/assets/sprites/action_place/insertBox.png', 1010, 480, 40, 40)
    player_press = sprite.ActionPlace('data/LEVEL_3n4/assets/sprites/action_place/button.png', 1010, 300, 40, 40)
    player_press_2 = sprite.ActionPlace('data/LEVEL_3n4/assets/sprites/action_place/button-left.png', 0, 470, 40, 40)
    ...
    bridge_plate = sprite.InfoPlate('data/LEVEL_3n4/assets/sprites/unmovable_obj/bridge.png', 950, 100, 50, 20)
    lvl2 = sprite.InfoPlate('data/LEVEL_3n4/assets/sprites/unmovable_obj/lvl2.png', 100, 300, 50, 20)
    ########## COLLISIONS ##################
    ...
    while running:
        ...
        if doors_action.flag:
            running = False
            data.progress.save_progress.update_progress('Level_3_2', True)
            flags.next_lvl_3_1.set_flag(True)
