...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.attack = 1
        self.velocity = 0
        self.image = pygame.image.load("data/LEVEL_1/assets/sprite_dog1.png")
        ...
        self.spritesWalkRight = [pygame.image.load('data/LEVEL_1/assets/sprite_dog1.png'),
                                 pygame.image.load('data/LEVEL_1/assets/sprite_dog2.png'),
                                 pygame.image.load('data/LEVEL_1/assets/sprite_dog_jump.png'),
                                 pygame.image.load('data/LEVEL_1/assets/sprite_dog3.png'),
                                 pygame.image.load('data/LEVEL_1/assets/sprite_dog4.png')]
        ...
        self.spritesJumpRight = pygame.image.load('data/LEVEL_1/assets/sprite_dog_jump.png')
