...
def main():
    ...
    jump_fx = pygame.mixer.Sound('data/LEVEL_5/music/audio_jump.wav')
    jump_fx.set_volume(.5)
    shot_fx = pygame.mixer.Sound('data/LEVEL_5/music/audio_shot.wav')
    shot_fx.set_volume(.5)
    bomb_fx = pygame.mixer.Sound('data/LEVEL_5/music/audio_grenade.wav')
    ...
    #load images
    #background image
    bg_img = pygame.image.load('data/LEVEL_5/img/pixelMars.png').convert_alpha()
    bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height))

    #button images
    start_btn = pygame.image.load('data/LEVEL_5/img/start_btn.png')
    restart_btn = pygame.image.load('data/LEVEL_5/img/restart_btn.png')
    exit_btn = pygame.image.load('data/LEVEL_5/img/exit_btn.png')

    #store tile images in list
    img_list = []
    for x in range(TILE_TYPES):
        img = pygame.image.load(f'data/LEVEL_5/img/Tiles/tile{x}.png')
        img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
        img_list.append(img)
    #energy ball
    ebullet_img = pygame.image.load('data/LEVEL_5/img/hsLaser.png').convert_alpha()
    ebullet_img = pygame.transform.scale(ebullet_img, (40, 40))
    #Alien bomb
    laser_img = pygame.image.load('data/LEVEL_5/img/yelball.png').convert_alpha()
    laser_img = pygame.transform.scale(laser_img, (30, 30))
    #Item drops
    health_drop_img = pygame.image.load('data/LEVEL_5/img/drops/health_drop.png').convert_alpha()
    health_drop_img = pygame.transform.scale(health_drop_img, (80, 80))
    energy_ammo_img = pygame.image.load('data/LEVEL_5/img/drops/energy_ammo.png').convert_alpha()
    energy_ammo_img = pygame.transform.scale(energy_ammo_img, (30, 22))
    special_ammo_img = pygame.image.load('data/LEVEL_5/img/drops/special_ammo.png').convert_alpha()
    ...
    class Dog(pygame.sprite.Sprite):
        def __init__(self, char_type, x, y, scale, speed, ammo, laser):
            ...
            for animation in animation_types:
                ...
                num_of_frames = len(os.listdir(f'data/LEVEL_5/img/{self.char_type}/{animation}'))
                for i in range(num_of_frames):
                    img = pygame.image.load(f'data/LEVEL_5/img/{self.char_type}/{animation}/char{i}.png').convert_alpha()
    ...
    class Explosion(pygame.sprite.Sprite):
        def __init__(self, x, y, scale):
            ...
            for num in range(0,6):
                img = pygame.image.load(f'data/LEVEL_5/img/explosions/explosion{num}.png').convert_alpha()
    ...
    with open(f'data/LEVEL_5/LevelEditor/level{level}_data.csv', newline='') as csvfile:
